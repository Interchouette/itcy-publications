...
Artefacts for **Interchouette ITC** LinkedIn posts and X tweets, written by [ITCy](https://github.com/Interchouette-ITC/itcy).
...
BUSL-1.1 (Interchouette-ITC). See [LICENSE](LICENSE) and [NOTICE](NOTICE). No SPDX inside `body.md`.
